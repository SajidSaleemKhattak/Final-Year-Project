          ...
          <div className="border border-neutral-200 rounded-2xl py-10 px-10 mt-10">
            <div className="flex flex-col gap-5">
              {array_appointments.map((element, index) => (
                <div
                  key={index}
                  className="flex justify-around  items-center border border-neutral-200 rounded-2xl px-5 py-5 gap-8"
                >
                  <div className="flex gap-4">
                    <img
                      className="w-12 h-12 rounded-full"
                      src={element.img}
                      alt={`${element.name} profile`}
                    />
                    <div>
                  ...
                  <div>
                    <button className="px-6 text-sm font-semibold py-2 bg-[#62B9CB] rounded-3xl text-white cursor-default">
                      Completed
                    </button>
                  </div>
                </div>
