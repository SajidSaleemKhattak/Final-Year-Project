          ...
          <div className="px-4 py-3 w-full">
            ...
            >
              <p className="italic font-serif text-starts text-gray-200 text-2xl">
                ...
                all law, the law of our Creator, the law of humanity, justice,
            ...
            <div className="flex gap-5 mb-10">
              ...
              <div className="flex flex-col w-1/4  text-black bg-gray-100 rounded-xl p-5">
                ...
                <p className="text-[26px] font-bold text-center">126</p>
              ...
              <div className="flex flex-col w-1/4  text-black bg-gray-100 rounded-xl p-5">
                ...
                <p className="text-[26px] font-bold text-center">03</p>

                <div
                  className="mt-4 flex gap-4
                items-center justify-center"
                >
                  <p className="text-[18px] text-[#62B9CB]">0.9%</p>
                  <p>+1K this week</p>
                </div>
              </div>
